---
name: mm3e-character-construction-pipeline
description: Domain-modeling pipeline for the MM3E [Character Construction] module. Runs domain-language, key-abstractions, abd-story-mapping pass 2, domain-sketch, and abd-acceptance-criteria with execute-rules-gate quality gates. Use when asked to run the pipeline or model the character-construction module.
---

# MM3E [Character Construction] Module Pipeline

You are a domain-modeling pipeline specialist. Process the **character-construction** module partition file through five ABD skills with quality gates at every step.

## Paths for this module

- **Partition file**: `c:\dev\mm3e-online-holistic\docs\modules\character-construction.md`
- **Output folder**: `c:\dev\mm3e-online-holistic\docs\character-construction\`
- **Growing module file**: `c:\dev\mm3e-online-holistic\docs\character-construction\character-construction.md`
- **Partition copy**: `c:\dev\mm3e-online-holistic\docs\character-construction\character-construction-module-partition.md`
...
1. Create folder `c:\dev\mm3e-online-holistic\docs\character-construction\`
2. Copy `docs/modules/character-construction.md` to `docs/character-construction/character-construction-module-partition.md` (read-only reference — do not modify after this step)
3. Create growing module file `docs/character-construction/character-construction.md` from the partition file content if it does not already exist
...
**Copy mode:** Write snapshot to `docs/character-construction/character-construction-domain-language.md`

**Quality gate AFTER:**
1. AI/rules pass — check output against every domain-language rule; state passes and failures
2. Scanner pass — `python c:\dev\agilebydesign-skills\skills\execute-skill-using-skills-rules\scripts\run_scanners.py --skill-root c:\Users\thoma\.cursor\skills\domain-language --workspace c:\dev\mm3e-online-holistic\docs\character-construction`
...
**Copy mode:** Write snapshot to `docs/character-construction/character-construction-key-abstractions.md`

**Quality gate AFTER:**
1. AI/rules pass — check output against every key-abstractions rule
2. Scanner pass — `python c:\dev\agilebydesign-skills\skills\execute-skill-using-skills-rules\scripts\run_scanners.py --skill-root c:\Users\thoma\.cursor\skills\key-abstractions --workspace c:\dev\mm3e-online-holistic\docs\character-construction`
3. Fix failures; re-run until clean
...
- Snapshot `docs/character-construction/character-construction-key-abstractions.md`
- Existing story map `docs/story-map.md` — identify the epic(s) that map to the character-construction domain
...
- Output both templates:
  - `docs/character-construction/story-map.md` (use template from `c:\Users\thoma\.cursor\skills\abd-story-mapping\templates\story-map.md`)
  - `docs/character-construction/story-map.txt` (plain-text twin with identical coverage)
...
2. Scanner pass — `python c:\dev\agilebydesign-skills\skills\execute-skill-using-skills-rules\scripts\run_scanners.py --skill-root c:\Users\thoma\.cursor\skills\abd-story-mapping --workspace c:\dev\mm3e-online-holistic\docs\character-construction`
3. Fix failures; re-run until clean
...
**Work:** Confirm `state: key-abstractions`. Read module file, all referenced chunks, and `docs/character-construction/story-map.md`. Follow the domain-sketch skill to:
...
**Copy mode:** Write snapshot to `docs/character-construction/character-construction-domain-sketch.md`

**Quality gate AFTER:**
1. AI/rules pass — check output against every domain-sketch rule
2. Scanner pass — `python c:\dev\agilebydesign-skills\skills\execute-skill-using-skills-rules\scripts\run_scanners.py --skill-root c:\Users\thoma\.cursor\skills\domain-sketch --workspace c:\dev\mm3e-online-holistic\docs\character-construction`
3. Fix failures; re-run until clean
...
Input context:
- Domain-sketch snapshot `docs/character-construction/character-construction-domain-sketch.md` — behaviors, interactions, invariants
- Module story map `docs/character-construction/story-map.md` — stories to write AC for
- All referenced source chunks
- Existing story map `docs/story-map.md` — broader context

Tasks:
- For every story in `docs/character-construction/story-map.md`, write WHEN/THEN/AND/BUT acceptance criteria
...
- Output both templates:
  - `docs/character-construction/acceptance-criteria.md` (use template from `c:\Users\thoma\.cursor\skills\abd-acceptance-criteria\templates\acceptance-criteria.md`)
  - `docs/character-construction/acceptance-criteria.txt` (plain-text twin with identical coverage)

**Quality gate AFTER:**
1. AI/rules pass — check output against every abd-acceptance-criteria rule
2. Scanner pass — `python c:\dev\agilebydesign-skills\skills\execute-skill-using-skills-rules\scripts\run_scanners.py --skill-root c:\Users\thoma\.cursor\skills\abd-acceptance-criteria --workspace c:\dev\mm3e-online-holistic\docs\character-construction`
3. Fix failures; re-run until clean
...
| File | Step |
|------|------|
| `character-construction-module-partition.md` | 0 |
| `character-construction.md` | 1-4 growing module file |
| `character-construction-domain-language.md` | 1 copy mode |
| `character-construction-key-abstractions.md` | 2 copy mode |
| `character-construction-domain-sketch.md` | 4 copy mode |
| `story-map.md` | 3 |
| `story-map.txt` | 3 |
