---
name: mm3e-power-pipeline
description: Domain-modeling pipeline for the MM3E [Power] module. Runs domain-language, key-abstractions, abd-story-mapping pass 2, domain-sketch, and abd-acceptance-criteria with execute-rules-gate quality gates. Use when asked to run the pipeline or model the power module.
---

# MM3E [Power] Module Pipeline

You are a domain-modeling pipeline specialist. Process the **power** module partition file through five ABD skills with quality gates at every step.

## Paths for this module

- **Partition file**: `c:\dev\mm3e-online-holistic\docs\modules\power.md`
- **Output folder**: `c:\dev\mm3e-online-holistic\docs\power\`
- **Growing module file**: `c:\dev\mm3e-online-holistic\docs\power\power.md`
- **Partition copy**: `c:\dev\mm3e-online-holistic\docs\power\power-module-partition.md`
...
1. Create folder `c:\dev\mm3e-online-holistic\docs\power\`
2. Copy `docs/modules/power.md` to `docs/power/power-module-partition.md` (read-only reference — do not modify after this step)
3. Create growing module file `docs/power/power.md` from the partition file content if it does not already exist
...
**Copy mode:** Write snapshot to `docs/power/power-domain-language.md`

**Quality gate AFTER:**
1. AI/rules pass — check output against every domain-language rule; state passes and failures
2. Scanner pass — `python c:\dev\agilebydesign-skills\skills\execute-skill-using-skills-rules\scripts\run_scanners.py --skill-root c:\Users\thoma\.cursor\skills\domain-language --workspace c:\dev\mm3e-online-holistic\docs\power`
...
**Copy mode:** Write snapshot to `docs/power/power-key-abstractions.md`

**Quality gate AFTER:**
1. AI/rules pass — check output against every key-abstractions rule
2. Scanner pass — `python c:\dev\agilebydesign-skills\skills\execute-skill-using-skills-rules\scripts\run_scanners.py --skill-root c:\Users\thoma\.cursor\skills\key-abstractions --workspace c:\dev\mm3e-online-holistic\docs\power`
3. Fix failures; re-run until clean
...
- Snapshot `docs/power/power-key-abstractions.md`
- Existing story map `docs/story-map.md` — identify the epic(s) that map to the power domain
...
- Output both templates:
  - `docs/power/story-map.md` (use template from `c:\Users\thoma\.cursor\skills\abd-story-mapping\templates\story-map.md`)
  - `docs/power/story-map.txt` (plain-text twin with identical coverage)
...
2. Scanner pass — `python c:\dev\agilebydesign-skills\skills\execute-skill-using-skills-rules\scripts\run_scanners.py --skill-root c:\Users\thoma\.cursor\skills\abd-story-mapping --workspace c:\dev\mm3e-online-holistic\docs\power`
3. Fix failures; re-run until clean
...
**Work:** Confirm `state: key-abstractions`. Read module file, all referenced chunks, and `docs/power/story-map.md`. Follow the domain-sketch skill to:
...
**Copy mode:** Write snapshot to `docs/power/power-domain-sketch.md`

**Quality gate AFTER:**
1. AI/rules pass — check output against every domain-sketch rule
2. Scanner pass — `python c:\dev\agilebydesign-skills\skills\execute-skill-using-skills-rules\scripts\run_scanners.py --skill-root c:\Users\thoma\.cursor\skills\domain-sketch --workspace c:\dev\mm3e-online-holistic\docs\power`
3. Fix failures; re-run until clean
...
Input context:
- Domain-sketch snapshot `docs/power/power-domain-sketch.md` — behaviors, interactions, invariants
- Module story map `docs/power/story-map.md` — stories to write AC for
- All referenced source chunks
- Existing story map `docs/story-map.md` — broader context

Tasks:
- For every story in `docs/power/story-map.md`, write WHEN/THEN/AND/BUT acceptance criteria
...
- Output both templates:
  - `docs/power/acceptance-criteria.md` (use template from `c:\Users\thoma\.cursor\skills\abd-acceptance-criteria\templates\acceptance-criteria.md`)
  - `docs/power/acceptance-criteria.txt` (plain-text twin with identical coverage)

**Quality gate AFTER:**
1. AI/rules pass — check output against every abd-acceptance-criteria rule
2. Scanner pass — `python c:\dev\agilebydesign-skills\skills\execute-skill-using-skills-rules\scripts\run_scanners.py --skill-root c:\Users\thoma\.cursor\skills\abd-acceptance-criteria --workspace c:\dev\mm3e-online-holistic\docs\power`
3. Fix failures; re-run until clean
...
| File | Step |
|------|------|
| `power-module-partition.md` | 0 |
| `power.md` | 1-4 growing module file |
| `power-domain-language.md` | 1 copy mode |
| `power-key-abstractions.md` | 2 copy mode |
| `power-domain-sketch.md` | 4 copy mode |
| `story-map.md` | 3 |
| `story-map.txt` | 3 |
